    ...
    function buildWorkflowFlowHTML(opts) {
        ...
        function cubeIOHtml(step, stepName) {
            ...
            if (sStatus === 'success' && step.output) {
                ...
                const metaLine = step.model ? `${step.time ? step.time + 'ms' : '-'} | ${step.tokens || '-'} tokens` : '';
